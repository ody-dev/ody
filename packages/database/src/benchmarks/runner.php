...
(new class ($options)
{
    protected ?\Ody\Database\Pool\PoolInterface $pool;
    ...
    protected function createPool(): \Ody\Database\Pool\PoolInterface
    {
        ...
        return \Ody\Database\ConnectionPool\ConnectionPoolFactory::create($this->options['pool.size'], $connectionFactory)
    ...
    protected function createPoolMimic(\Ody\Database\Pool\PoolItemFactoryInterface $factory): \Ody\Database\Pool\PoolInterface
    {
        return new class ($factory) implements \Ody\Database\Pool\PoolInterface {
            protected array $itemList;

            public function __construct(
                protected readonly \Ody\Database\Pool\PoolItemFactoryInterface $factory,
            ) {
                $this->itemList = [];
            }
    ...
    protected function createConnectionFactory(): \Ody\Database\Pool\PoolItemFactoryInterface
    {
        return new class($this->options) implements \Ody\Database\Pool\PoolItemFactoryInterface {
            public function __construct(
                protected readonly array $options,
            ) {
            }
            ...
            public function create(): mixed
            {
                ...
                try {
                    ...
                    throw new \Ody\Database\Pool\Exceptions\PoolItemCreationException(
