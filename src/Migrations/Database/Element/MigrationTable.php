...
use Ody\DB\Migrations\Database\Element\Behavior\AutoIncrementBehavior;
use Ody\DB\Migrations\Database\Element\Behavior\CharsetAndCollationBehavior;
use Ody\DB\Migrations\Database\Element\Behavior\ColumnsToChangeBehavior;
use Ody\DB\Migrations\Database\Element\Behavior\ColumnsToDropBehavior;
use Ody\DB\Migrations\Database\Element\Behavior\ColumnsToRenameBehavior;
use Ody\DB\Migrations\Database\Element\Behavior\CommentBehavior;
use Ody\DB\Migrations\Database\Element\Behavior\CopyTableBehavior;
use Ody\DB\Migrations\Database\Element\Behavior\DropPrimaryKeyBehavior;
use Ody\DB\Migrations\Database\Element\Behavior\ForeignKeyBehavior;
use Ody\DB\Migrations\Database\Element\Behavior\IndexBehavior;
use Ody\DB\Migrations\Database\Element\Behavior\PrimaryColumnsBehavior;
use Ody\DB\Migrations\Database\Element\Behavior\UniqueConstraintBehavior;
