...
namespace Ody\DB\ConnectionPool\Pool\TimerTask;

use Swoole\Timer;
use WeakReference;
use LogicException;
use Ody\DB\ConnectionPool\Pool\Exceptions\TimerTickScheduleException;
...
class TimerTaskScheduler implements TimerTaskSchedulerInterface
{
    ...
    public function __construct(
        ...
        foreach ($this->timerTasks as $timerTask) {
            /** @see \Ody\DB\ConnectionPool\Pool\TimerTask\TimerTaskSchedulerAwareTrait */
